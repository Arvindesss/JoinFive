...
public class RankingInterface extends Application {
    ...
    public RankingInterface(List<Player> players) {
        this.players = players.stream().sorted(Comparator.comparingDouble(Player::getScore).reversed()).collect(Collectors.toList());
    }
    ...
    public void start(Stage primaryStage) {
        ...
        tableView.getColumns().addAll(playerNameCol, playerScoreCol);
